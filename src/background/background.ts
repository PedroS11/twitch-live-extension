...
import { displayNumberOfLivestreams, processBadgeIconAlarm } from "../infrastructure/background/badgeIcon";
import {
...
chrome.notifications.onClicked.addListener(
	async (notificationId: string) => await processOnNotificationClick(notificationId),
);

chrome.runtime.onInstalled.addListener(async (details: InstalledDetails) => await processOnInstallEvents(details));
